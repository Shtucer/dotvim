...
let g:colors_name="zenburn-no-bold"
...
hi Todo            guifg=#c3bf9f guibg=#2f2f2f gui=underline
hi Typedef         guifg=#dfe4cf 
hi Type            guifg=#dfdfbf term=none cterm=none gui=none
...
if &t_Co > 255
    ...
    if exists("g:zenburn_alternate_Error") && g:zenburn_alternate_Error
        ...
        hi Error ctermfg=210 ctermbg=52 
    else
...
if exists("g:zenburn_alternate_Error") && g:zenburn_alternate_Error
    " use more jumpy Error
    hi Error        guifg=#e37170 guibg=#664040 
else
    " default is something more zenburn-compatible
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    if &t_Co > 255
        ...
        hi TabLineSel    ctermbg=235 ctermfg=186 cterm=none
        hi TabLineFill   ctermbg=236 ctermfg=236 cterm=none
    endif
else
    ...
    if &t_Co > 255
        ...
        hi TabLineFill   ctermbg=233 ctermfg=233 cterm=none
    endif
endif
